...
const mapRecognizeMatch = (item) => {
    ...
    const name = pick(item, 'songname', 'filename', 'name') || i18n.global.t('wei-zhi-ge-qu');
    const author = pick(item, 'singername', 'author_name', 'singer') || i18n.global.t('wei-zhi-ge-shou');
