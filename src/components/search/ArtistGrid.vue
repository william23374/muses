    ...
    <div v-for="(artist, index) in artists" :key="index" class="artist-card" @click="onArtistClick(artist)"
      ...
      <div class="artist-info">
        ...
        <div class="artist-counts">
          <div class="count-item">{{ $t('zhuan-ji-shu') }}: {{ artist.AlbumCount }}</div>
          <div class="count-item">{{ $t('dan-qu-shu') }}: {{ artist.AudioCount }}</div>
          <div class="count-item">{{ $t('shi-pin-shu') }}: {{ artist.VideoCount }}</div>
        </div>
      </div>
    </div>
  </div>
