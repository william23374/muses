...
const props = defineProps({
    // Scroll container selector to manage
    target: { type: String, default: '.app-main-scroll' },
    // Hide delay after scroll stops (ms)
...
// Align track to scroll container viewport (minus nav/player padding)
const measure = () => {
    if (!container) return;
...
// Click track: jump handle center to click, then drag
...
const bind = () => {
    ...
    // Observe container and content so slider ratio updates as paginated songs load
